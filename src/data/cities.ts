...
export const cities: City[] = [
	{
		...
		name: 'Rio de Janeiro',
		country: 'Brasil',
		coverImage: require('./images/rio-de-janeiro.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Tóquio',
		country: 'Japão',
		coverImage: require('./images/tokyo.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Bangkok',
		country: 'Tailândia',
		coverImage: require('./images/bangkok.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Barcelona',
		country: 'Espanha',
		coverImage: require('./images/barcelona.jpg') as number,
		description:
	...
	},
	{
		...
		coverImage: require('./images/new-york.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Krabi',
		country: 'Tailândia',
		coverImage: require('./images/krabi.jpg') as number,
		description:
...

	{
		...
		name: 'Bali',
		country: 'Indonésia',
		coverImage: require('./images/bali.jpg') as number,
		description:
	...
	},
	{
		...
		coverImage: require('./images/amsterdam.jpg') as number,
		description:
...

	{
		...
		name: 'Cancún',
		country: 'México',
		coverImage: require('./images/cancun.jpg') as number,
		description:
...

	{
		...
		coverImage: require('./images/dubai.jpg') as number,
		description:
...

	{
		...
		country: 'México',
		coverImage: require('./images/ciudad-de-mexico.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Hong Kong',
		country: 'China',
		coverImage: require('./images/hong-kong.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Košice',
		country: 'Eslováquia',
		coverImage: require('./images/kosice.jpg') as number,
		description:
	...
	},
	{
		...
		name: 'Melbourne',
		country: 'Austrália',
		coverImage: require('./images/melbourne.jpg') as number,
		description:
...

	{
		...
		name: 'Singapura',
		country: 'Singapura',
		coverImage: require('./images/singapore.jpg') as number,
		description:
